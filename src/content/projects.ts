...
export const projects: Project[] = [
  // ==========================================================================
  // FEATURED PROJECT 1: CARBON SHOP
  // ==========================================================================
  {
    slug: "carbon-shop",
    title: "Carbon Shop – Carbon Credit Marketplace",
    summary: "Real-time carbon credit trading platform: live listings, dynamic dashboards, role-based access for issuers/buyers/auditors, and registry integrations.",
    role: "Full-Stack Developer (SDE III) – Project Lead",
    dates: "Mar 2023 – Jul 2024",
    company: "Climate Connect Digital (ReNew Power)",
    domain: "ClimateTech",
    stack: [
      "React",
      "Next.js",
    ...
    links: [
      { label: "Live Demo", href: "https://app.carbonshop.digital/", kind: "demo" },
      { label: "Climate Connect Digital", href: "https://www.climateconnect.digital/", kind: "site" },
    ],
    detailHref: "/projects/carbon-shop",

    images: [
      {
        src: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&h=600&fit=crop",
        alt: "Carbon credit trading dashboard showing live market data, price charts, and transaction logs",
      },
    ],
