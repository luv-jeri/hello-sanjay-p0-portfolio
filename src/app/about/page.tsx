              ...
              <div className="grid gap-12 md:grid-cols-[2fr_3fr] md:gap-16">
                <div className="space-y-4">
                  <h2 className="text-4xl font-bold tracking-tight md:text-5xl">
                    Building the
                    <br />
                    Future of Web<span className="text-blue-500">.</span>
                  </h2>
                ...
                <div className="space-y-6 text-base leading-relaxed text-muted-foreground md:text-lg">
                  <p className="text-foreground/90">
                    With over <Highlighter action="highlight" color="#fef3c7" strokeWidth={2} padding={4} isView>6+ years of experience</Highlighter>, I specialize in crafting scalable, performant web applications. Currently leading{" "}
                    <Highlighter action="underline" color="#3b82f6" strokeWidth={2} padding={2} isView>frontend architecture at HighLevel</Highlighter>,
                    where I&apos;ve architected and delivered multiple high-impact features.
                  </p>
                  <p>
                    My expertise spans the full stack, with deep focus on modern JavaScript frameworks, performance optimization, and{" "}
                    <Highlighter action="box" color="#10b981" strokeWidth={2} padding={4} isView>building design systems</Highlighter>{" "}
                    that scale. I&apos;m passionate about creating exceptional user experiences and mentoring developers.
                  </p>
                  <p>
                    Beyond coding, I contribute to the developer community through{" "}
                    <Highlighter action="circle" color="#ef4444" strokeWidth={2} padding={6} isView>technical mentorship</Highlighter>,
                    having trained 200+ developers in modern web technologies.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="relative">
                ...
                <blockquote className="relative space-y-6">
                  <p className="text-2xl font-light italic leading-relaxed text-foreground/90 md:text-3xl lg:text-4xl">
                    Design systems should inspire creativity &mdash; not constrain it.
                    Code should be a canvas, not a cage.
                  </p>
            ...
            <section className="py-16 md:py-20">
              <div className="space-y-12">
                <div className="space-y-3">
                  ...
                  <p className="text-base text-muted-foreground md:text-lg">
                    Core principles that guide my approach to development
                  </p>
                </div>
